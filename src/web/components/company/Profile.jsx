...
class Profile extends Component {
    ...
    deleteData = () => {
        const url = process.env.REACT_APP_BASE_URL+`api/v1/companies/${this.props.Profile.CompanyId}`
        const config =(
            { headers: { 
    ...
    render() {
        ...
        return (
            ...
            <Container className='justify-content-center mt-3' style={{ paddingBottom:'20px'}}>
                ...
                <Card style={{ marginBottom:'15px', marginRight: '20px', borderRadius:'12%', width: '14rem', height:'20rem', backgroundImage: `url(`+process.env.REACT_APP_BASE_URL+`uploads/companies/${this.props.Profile.CompanyLogo})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
                <Card.Body style={{ height: '200px'}}>
                </Card.Body>
                </Card>}</Col>
                <Col>
