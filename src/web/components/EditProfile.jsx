...
class EditProfile extends Component {
    ...
    componentDidMount(){
        ...
        this.setState({
            ...
            expected_salary: this.props.Profile.expectedSalary,
    ...
    Update = e =>{
        ...
        const url = process.env.REACT_APP_BASE_URL+`api/v1/engineers/${localStorage.getItem('id')}`
    ...
    render() {
        return (
            ...
            <Col md='3'>
            <Card style={{ marginBottom:'15px', marginRight: '20px', borderRadius:'12%', width: '14rem', height:'20rem', backgroundImage: `url(`+process.env.REACT_APP_BASE_URL+`uploads/engineers/${this.state.photo})`,backgroundPosition:'center', backgroundSize: 'cover' }}>
