...
class Search extends Component {
    ...
    searchEngineers = e => {
        ...
        this.props.fetch(process.env.REACT_APP_BASE_URL+`api/v1/engineers?page=1?&name=${key}`)
    }
        ...
        return (
            <>
                ...
                <InputGroup>
                    ...
                    <FormControl  type="text" style={{backgroundColor: '#DADADA', borderRadius:' 0px 10px 10px 0px'}} placeholder="Search" onChange={this.searchEngineers} className="mr-sm-2" />
                </InputGroup>
            </Form>
            </>
        )
